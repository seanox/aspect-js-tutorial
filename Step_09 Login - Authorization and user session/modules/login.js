...
window['login'] = {
    ...
    logon: {
        onClick: function(event) {
            ...
            //The method is only called if the validation of form and model is
            //successful. The user has successfully authenticated.
            Session.logon(login.user, login.password);
        },
    },
